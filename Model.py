...
class Model():
    ...
    def __init__(self, trained=False):
        ...
        if trained: self.model.load_state_dict(torch.load('checkpoints/TOMATO_LEAF_PLANTVILLAGE_EFFICIENTNET_10CLASSES_V1_6.tar', map_location=torch.device(DEVICE))['model_state_dict'])
